...
class InferenceResult:
    ...
    mat_original_image: Optional[PIL.Image.Image]
...
def run_local_inference(
    ...
    return InferenceResult(
        ...
        mat_original_image=(
            run_generator_on_inputs(preset.mat_original_checkpoint, input_image, binary_mask, device)
            if preset.mat_original_checkpoint
            else None
        ),
        pipeline_notes={
...
def run_remote_inference(
    ...
    response = requests.post(
        ...
        json={
            ...
            "mat_original_checkpoint": preset.mat_original_checkpoint,
        },
    ...
    return InferenceResult(
        ...
        mat_original_image=(
            base64_to_pil(payload["mat_original_image"])
            if payload.get("mat_original_image")
            else None
        ),
